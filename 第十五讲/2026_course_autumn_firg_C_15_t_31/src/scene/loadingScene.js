export default class loadingScene extends Phaser.Scene {
    ...
    loadGameAssets() {
        ...
        this.load.image('hand1', 'assets/png/gameScene/hand1.png');
        this.load.image('hand2', 'assets/png/gameScene/hand2.png');
        this.load.image('hand3', 'assets/png/gameScene/hand3.png');
        ...
        this.load.spineBinary('lifangti_data', 'assets/spine/lifangti.skel');
        this.load.spineAtlas('lifangti_atlas', 'assets/spine/lifangti.atlas');
