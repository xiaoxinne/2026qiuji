...
export default class loadingScene extends Phaser.Scene {
    ...
    loadGameAssets() {
        ...
        this.load.image('fireman1', 'assets/png/gameScene/fireman1.png');
        this.load.image('fireman2', 'assets/png/gameScene/fireman2.png');
        this.load.image('fireman3', 'assets/png/gameScene/fireman3.png');
