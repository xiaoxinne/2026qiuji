...
export default class loadingScene extends Phaser.Scene {
    ...
    loadGameAssets() {
        ...
        this.load.image('que2_1', 'assets/png/gameScene/que2_1.png');
        this.load.image('que2_2', 'assets/png/gameScene/que2_2.png');
        ...
        this.load.image('answer2', 'assets/png/gameScene/answer2.png');
        this.load.image('answer5', 'assets/png/gameScene/answer5.png');
        this.load.image('answer10', 'assets/png/gameScene/answer10.png');
        this.load.image('answer11', 'assets/png/gameScene/answer11.png');
        this.load.image('answer15', 'assets/png/gameScene/answer15.png');
        this.load.image('tips2_1', 'assets/png/gameScene/tips2_1.png');
        this.load.image('tips2_2', 'assets/png/gameScene/tips2_2.png');
        this.load.image('tips2_3', 'assets/png/gameScene/tips2_3.png');
        this.load.image('tips2_4', 'assets/png/gameScene/tips2_4.png');
    
        this.load.image('reset', 'assets/png/common/reset.png');
        this.load.image('reset_s', 'assets/png/common/reset_s.png');
        this.load.image('prev', 'assets/png/common/prev.png');
        this.load.image('prev_s', 'assets/png/common/prev_s.png');
        this.load.image('next', 'assets/png/common/next.png');
        this.load.image('next_s', 'assets/png/common/next_s.png');
