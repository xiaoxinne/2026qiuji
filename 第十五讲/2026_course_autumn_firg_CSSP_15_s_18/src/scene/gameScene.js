...
/** 三关填空：第1关 area1，第2关 area2，第3关 area3 */
const LEVELS = [
    {
        soundKey: 'title1',
        areas: [
            { key: 'area1', x: 934, y: 474 },
        ],
        answerSlots: [
            { x: 1253, y: 473 },
        ],
...
export default class gameScene extends Phaser.Scene {
    constructor() {
        ...
        ReportHelper.gameReportParams.question_id = '2026_course_autumn_firg_CSSP_15_s_18';
    ...
    create() {
        ...
        this.titleImage = this.add.image(960, 92, 'title1');
    ...
    playLevelTitle() {
        ...
        this.trumpet.setSoundKey?.('title1');
