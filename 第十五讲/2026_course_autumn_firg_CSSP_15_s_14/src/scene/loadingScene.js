export default class loadingScene extends Phaser.Scene {
    ...
    loadGameAssets() {
        ...
        this.load.image('title2', 'assets/png/gameScene/title2.png');
        this.load.image('title3', 'assets/png/gameScene/title3.png');
        this.load.image('area1', 'assets/png/gameScene/area1.png');
        this.load.image('area2', 'assets/png/gameScene/area2.png');
        this.load.image('area3', 'assets/png/gameScene/area3.png');
        this.load.image('area4', 'assets/png/gameScene/area4.png');
        ...
        this.load.image('clear', 'assets/png/common/clear.png');
        this.load.image('clear_s', 'assets/png/common/clear_s.png');
        this.load.image('clear_d', 'assets/png/common/clear_d.png');

        this.load.image('answer_bg', 'assets/png/gameScene/answer_bg.png');
        this.load.image('answer_bg_s', 'assets/png/gameScene/answer_bg_s.png');
        this.load.image('answer_bg_r', 'assets/png/gameScene/answer_bg_r.png');
        this.load.image('num_bg', 'assets/png/gameScene/num_bg.png');
        for (let i = 0; i <= 9; i += 1) {
            this.load.image(`num_${i}`, `assets/png/gameScene/num_${i}.png`);
            this.load.image(`num_${i}_s`, `assets/png/gameScene/num_${i}_s.png`);
        ...
        this.load.audio('title3', 'assets/audio/title3.mp3');
    }
}
