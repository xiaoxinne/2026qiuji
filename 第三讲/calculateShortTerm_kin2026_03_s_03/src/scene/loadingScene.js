...
export default class loadingScene extends Phaser.Scene {
    ...
    loadGameAssets() {
        ...
        this.load.image('que1', 'assets/png/gameScene/que1.png');
        this.load.image('que2', 'assets/png/gameScene/que2.png');
        this.load.image('que3', 'assets/png/gameScene/que3.png');
        this.load.image('option_bg', 'assets/png/gameScene/option_bg.png');
        this.load.image('option_bg_s', 'assets/png/gameScene/option_bg_s.png');
        this.load.image('option_bg_r', 'assets/png/gameScene/option_bg_r.png');
        this.load.image('arraw', 'assets/png/gameScene/arraw.png');
