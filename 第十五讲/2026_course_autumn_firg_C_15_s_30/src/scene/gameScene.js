...
export default class gameScene extends Phaser.Scene {
    constructor() {
        ...
        ReportHelper.gameReportParams.question_id = '2026_course_autumn_firg_C_15_s_30';
    ...
    create() {
        ...
        this.add.image(960, 784, 'num_bg').setDepth(20);
    ...
    setupLevelAreas(levelIndex) {
        ...
        this.areaImages = (level.areas || []).map((area, index) => {
