...
export default class loadingScene extends Phaser.Scene {
    ...
    loadGameAssets() {
        ...
        this.load.image('tips_txt', 'assets/png/gameScene/tips_txt.png');
        this.load.image('pot', 'assets/png/gameScene/pot.png');
        this.load.image('item_apple', 'assets/png/gameScene/item_apple.png');
        this.load.image('item_apple2', 'assets/png/gameScene/item_apple2.png');
        this.load.image('icon_shou', 'assets/png/gameScene/icon_shou.png');
        this.load.image('button_bg', 'assets/png/gameScene/button_bg.png');
        this.load.image('button_wh', 'assets/png/gameScene/button_wh.png');
        this.load.image('ss_1', 'assets/png/gameScene/ss_1.png');
        this.load.image('answer', 'assets/png/gameScene/answer.png');
